...
def seed():
    ...
    try:
        ...
        accommodations = [
            ...
            Accommodation(
                name="Italian Countryside House",
                category=CategoryShema.HOUSE,
                host_id=hosts[6].id,
                numRooms=4,
                is_available=True
